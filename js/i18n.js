...
window.I18N = {
  ...
  ru: {
    ...
    facts: { items: [
      ...
      { num: "Матчмейкинг", label: "Встречи по вашей категории продукции" },
    ...
    results: {
      ...
      lead: "Технологию проводит ООО «Империя Форум». Совокупные результаты платформы на деловых мероприятиях за последние сезоны:",
      items: [
        { num: "3 500+", label: "переговоров на площадках формата" },
        { num: "2 800+", label: "заключённых договоров" },
    ...
    aud: {
      ...
      supplier: {
        ...
        items: [
          "Прямой доступ к закупщикам, уполномоченным заключать сделки.",
          "Матчмейкинг: подбор встреч с закупщиками по вашей категории продукции.",
          "Технология подготовки продающего коммерческого предложения под требования закупщика.",
    ...
    how: {
      ...
      steps: [
        ...
        { n: "03", title: "Подготовка к переговорам", text: "В личном кабинете — обучающий вебинар и видеозапись: как эффективно провести переговоры с закупщиком." },
        { n: "04", title: "Переговоры за столами", text: "Целевые встречи в переговорной зоне Узэкспоцентра — по расписанию." },
        { n: "05", title: "Договорённости", text: "Итоги и предварительный договор фиксируются в личном кабинете." }
      ],
      hall: {
        title: "Как устроен зал",
        desc: "В центре зала — ядро из десятков переговорных столов с закупщиками. Вокруг — промо-стенды поставщиков: вешалки с образцами, продукция и оборудование. Закупщик переходит от стенда к стенду и оценивает продукт вживую."
      },
      gallery: {
